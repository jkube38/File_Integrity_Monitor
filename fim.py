...
def create_parser():
    ...
    parser.add_argument('-s', '--save', help='Use the flags with a full path to save the current log file to a '
                        'specified destination directory (do not include slash a the end of the path).')
